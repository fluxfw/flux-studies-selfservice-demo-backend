...
installLibrary flux-http-api https://github.com/fluxfw/flux-http-api/archive/refs/tags/v2023-01-12-2.tar.gz
...
installLibrary flux-studis-selfservice-frontend/src https://github.com/fluxfw/flux-studis-selfservice-frontend/releases/download/v2023-01-12-1/flux-studis-selfservice-frontend-v2023-01-12-1-build.tar.gz
