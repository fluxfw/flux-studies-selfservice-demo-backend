...
installLibrary flux-form https://github.com/fluxfw/flux-form/archive/refs/tags/v2023-07-10-1.tar.gz

installLibrary flux-http-api https://github.com/fluxfw/flux-http-api/archive/refs/tags/v2023-06-19-1.tar.gz

installLibrary flux-pwa-generator https://github.com/fluxfw/flux-pwa-generator/archive/refs/tags/v2023-06-26-1.tar.gz
...
installLibrary flux-studis-selfservice-frontend/src https://github.com/fluxfw/flux-studis-selfservice-frontend/releases/download/v2023-06-30-2/flux-studis-selfservice-frontend-v2023-06-30-2-build.tar.gz
