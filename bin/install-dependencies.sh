...
installDependency flux-config-api https://github.com/fluxfw/flux-config-api/archive/refs/tags/v2022-12-06-1.tar.gz
...
installDependency flux-studis-selfservice-frontend/src https://github.com/fluxfw/flux-studis-selfservice-frontend/releases/download/v2022-12-07-1/flux-studis-selfservice-frontend-v2022-12-07-1-build.tar.gz
