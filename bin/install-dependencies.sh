...
installDependency flux-express-server-api https://github.com/fluxfw/flux-express-server-api/archive/refs/tags/v2022-11-24-1.tar.gz
...
installDependency flux-studis-selfservice-frontend/src https://github.com/fluxfw/flux-studis-selfservice-frontend/releases/download/v2022-11-24-1/flux-studis-selfservice-frontend-v2022-11-24-1-build.tar.gz
