...
(mkdir -p $node_modules/flux-studies-selfservice-frontend && cd $node_modules/flux-studies-selfservice-frontend && wget -O - https://github.com/fluxfw/flux-studies-selfservice-frontend/archive/refs/tags/v2022-10-28-1-alpha.tar.gz | tar -xz --strip-components=1 && npm ci --omit=dev)
